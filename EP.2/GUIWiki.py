...
# ปุ่มค้นหา
def Search():
    keyword = v_search.get() # .get()คือ ดึงข้อมูล
    try:
        # ลองค้นหาดูว่าได้ผลรับหรือไม่ หากได้ให้ผ่านไป
    ...
    #print(result)
    #v_result.set(result)#สั่งให้แสดงใน GUI


B1 = ttk.Button(GUI,text='Search',command=Search)
B1.pack(ipadx=20,ipady=10) #ipadx ขยายภายในปุ่นแนวนอน

# เลือกภาษา
F1 = Frame(GUI)
F1.pack(pady=10)

v_radio = StringVar()# ช้องเก็บข้อมูลภาษา
